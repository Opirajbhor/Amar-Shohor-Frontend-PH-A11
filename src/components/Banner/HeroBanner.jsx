...
const HeroBanner = () => {
  return (
    <section className="bg-gradient-to-b from-green-50 to-blue-50 dark:from-green-900 mt-5 dark:to-gray-800">
      <div className="max-w-screen-xl mx-auto px-4 py-20 grid lg:grid-cols-12 gap-10">
